...
Thanks for your interest in contributing to mpvNext!
...
Ensure you have cloned the latest code for mpvNext:
```bash
git clone https://github.com/aransari1/mpvNext.git
cd mpvNext
```

#### 3. Start Droidlate
Open your terminal in the root of the mpvNext directory and run:
```bash
droidlate
```
